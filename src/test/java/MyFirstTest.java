...
public class MyFirstTest {
    ...
    public static final String SITE_URL = "http://github.com/";

    @Test(dataProvider = "providePageNameToSearch")
    public void checkPageTest(String page) throws IOException, InterruptedException {
        sleep(1000);
